    ...
    public class ProductController : Controller
    {
            ...
            string filter = null, string pageNr = "0", string pageSize = "10")
        {
            try
            {
                ...
                var resp = await _service.ReadProductAsync(seededArg, flatArg, filter?.Trim().ToLower(), pageNrArg, pageSizeArg);     
                return Ok(resp);     
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> ReadItem(string id = null, string flat = "false")
        {
            try
            {
                ...
                var item = await _service.ReadProductAsync(idArg, flatArg);
        ...
        public async Task<IActionResult> DeleteItem(string id)
        {
            try
            {
                ...
                var item = await _service.DeleteProductAsync(idArg);
                if (item?.Item == null) throw new ArgumentException ($"Item with id {id} does not exist");
        ...
        [Authorize(AuthenticationSchemes = Microsoft.AspNetCore.Authentication.JwtBearer.JwtBearerDefaults.AuthenticationScheme,
            Policy = null, Roles = "supusr, sysadmin")]
        [HttpGet()]
        [ProducesResponseType(200, Type = typeof(ResponseItemDTO<ProductCuDTO>))]
        [ProducesResponseType(400, Type = typeof(string))]
        [ProducesResponseType(404, Type = typeof(string))]
        public async Task<IActionResult> ReadItemDto(string id = null)
        {
            try
            {
                ...
                var item = await _service.ReadProductAsync(idArg, false);
                if (item?.Item == null) throw new ArgumentException ($"Item with id {id} does not exist");
        ...
        public async Task<IActionResult> UpdateItem(string id, [FromBody] ProductDTO item)
        {
            try
            {
                ...
                if (item.ProductId != idArg) throw new ArgumentException("Id mismatch");

                var _item = await _service.UpdateProductAsync(item);
        ...
        public async Task<IActionResult> CreateItem([FromBody] ProductDTO item)
        {
            try
            {
                ...
                var _item = await _service.CreateProductAsync(item);
                _logger.LogInformation($"item {_item.Item.ProductId} created");
