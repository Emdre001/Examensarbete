    ...
    return (
        ...
        <div className="content-center">
            ...
            <p className="contact-email">
                <strong>Email:</strong> <a href="mailto:shoes.storecompany2025@gmail.com">shoes.storecompany2025@gmail.com</a>
            </p>
            ...
            <div className="social-icons">
                <a href="mailto:shoes.storecompany2025@gmail.com" target="_blank" rel="noopener noreferrer">
                    <FaEnvelope size={30} />
                </a>
            </div>
